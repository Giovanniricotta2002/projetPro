...
final class Version20250726233736 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql("INSERT INTO info_machine (machine_id, text, type) VALUES
            ((Select id from machine where uuid = '019870e7-ec64-77fa-9909-6dc7379243de'), 'Polyvalents pour tout le corps', 'carac'),
            ((Select id from machine where uuid = '019870e7-ec64-77fa-9909-6dc7379243de'), 'Peu encombrants', 'carac'),
            ((Select id from machine where uuid = '019870e7-ec64-77fa-9909-6dc7379243de'), 'Adaptés au renforcement, à la tonification ou à la prise de masse', 'carac'),
            ((Select id from machine where uuid = '019870e7-ec64-77fa-9909-6dc7379243de'), 'Excellents pour les circuits training ou les entraînements fonctionnels', 'carac'),
            ((Select id from machine where uuid = '019870e7-ec64-77fa-9909-6dc7379243de'), 'Fonte brute, acier chromé, caoutchouc, néoprène ou vinyle selon l’usage et le confort', 'autre'),
            ((Select id from machine where uuid = '019870e7-ec64-77fa-9909-6dc7379243de'), 'Polyvalents pour tout le corps', 'carac'),
            ((Select id from machine where uuid = '019870e7-ec64-77fa-9909-6dc7379243de'), 'Peu encombrants', 'carac'),
            ((Select id from machine where uuid = '019870e7-ec64-77fa-9909-6dc7379243de'), 'Adaptés au renforcement, à la tonification ou à la prise de masse', 'carac'),
            ((Select id from machine where uuid = '019870e7-ec64-77fa-9909-6dc7379243de'), 'Excellents pour les circuits training ou les entraînements fonctionnels', 'carac'),
            ...
            ((Select id from machine where uuid = '019870ee-3773-78aa-8523-5fe15a868d8b'), 'Ciblage précis des muscles', 'carac'),
            ((Select id from machine where uuid = '019870ee-3773-78aa-8523-5fe15a868d8b'), 'Réduction du risque de blessure', 'confort'),
            ((Select id from machine where uuid = '019870ee-3773-78aa-8523-5fe15a868d8b'), 'Idéal pour la progression en charge contrôlée', 'carac'),
            ((Select id from machine where uuid = '019870ee-3773-78aa-8523-5fe15a868d8b'), 'Confort d''utilisation grâce aux réglages ergonomiques', 'confort'),
            ((Select id from machine where uuid = '019870ee-3773-78aa-8523-5fe15a868d8b'), 'Structure en acier robuste', 'carac'),
            ((Select id from machine where uuid = '019870ee-3773-78aa-8523-5fe15a868d8b'), 'Siège réglable', 'carac'),
            ((Select id from machine where uuid = '019870ee-3773-78aa-8523-5fe15a868d8b'), 'Résistance par charge guidée ou poids libres', 'carac'),
            ((Select id from machine where uuid = '019870ee-3773-78aa-8523-5fe15a868d8b'), 'Poignées antidérapantes', 'carac'),
            ((Select id from machine where uuid = '019870f3-9205-7fe4-825c-ba83fae007d7'), 'Tout-en-un : travail complet du corps', 'autre'),
            ((Select id from machine where uuid = '019870f3-9205-7fe4-825c-ba83fae007d7'), 'Gain de place : idéal pour les petits espaces', 'autre'),
            ((Select id from machine where uuid = '01987115-f9a2-794e-a1ad-6c9d87691603'), 'Mouvement guidé pour un entraînement sécurisé', 'sécurité'),
            ((Select id from machine where uuid = '01987115-f9a2-794e-a1ad-6c9d87691603'), 'Tout-en-un : travail complet du corps', 'autre'),
            ((Select id from machine where uuid = '01987115-f9a2-794e-a1ad-6c9d87691603'), 'Tout-en-un : travail complet du corps', 'autre'),
            ((Select id from machine where uuid = '01987115-f9a2-794e-a1ad-6c9d87691603'), 'Type d''utilisateur : débutant à avancé', 'usage'),
            ((Select id from machine where uuid = '01987115-f9a2-794e-a1ad-6c9d87691603'), 'Type d''utilisateur : débutant à avancé', 'usage'),
            ((Select id from machine where uuid = '01987115-f9a2-794e-a1ad-6c9d87691603'), 'Type d''utilisateur : débutant à avancé', 'usage'),
            ((Select id from machine where uuid = '01987115-f9a2-794e-a1ad-6c9d87691603'), 'Type d''utilisateur : débutant à avancé', 'usage'),
            ((Select id from machine where uuid = '01987115-f9a2-794e-a1ad-6c9d87691603'), 'Type d''utilisateur : débutant à avancé', 'usage'),
            ((Select id from machine where uuid = '01987115-f9a2-794e-a1ad-6c9d87691603'), ' débutant à avancé', 'usage'),
            ((Select id from machine where uuid = '01987115-f9a2-794e-a1ad-6c9d87691603'), 'Amorti : système d’absorption des chocs pour préserver les articulations', 'confort'),
            ((Select id from machine where uuid = '01987115-f9a2-794e-a1ad-6c9d87691603'), 'système d’absorption des chocs pour préserver les articulations', 'confort'),
            ((Select id from machine where uuid = '01987115-f9a2-794e-a1ad-6c9d87691603'), 'système d’absorption des chocs pour préserve', 'confort')
        ");
        ...
        $this->addSql("INSERT INTO post (forum_id, titre, date_creation, vues, verrouille, epingle, utilisateur_id) VALUES
            ((SELECT id FROM forum WHERE titre = 'fezfez'), 'efzfez', '2025-08-03 20:33:00', 0, FALSE, FALSE, 1)
        ");
    }
