...
final class Version20250726233736 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(
            'INSERT INTO forum (id, utilisateur_id, titre, date_creation, date_cloture, description, ordre_affichage, visible, slug, created_at, updated_at, deleted_at) VALUES ' .
            "(2, NULL, 'fezfez', '2025-08-03 20:20:48', NULL, '', 1, TRUE, '', '2025-08-03', NULL, NULL)"
        );

        // Ajout des machines
        $this->addSql("INSERT INTO machine (id, forum_id, uuid, name, date_creation, date_modif, visible, image, description, utilisateur_id) VALUES
            (2, NULL, '019870ee-3773-78aa-8523-5fe15a868d8b', 'Appareil de musculation Press', '2025-08-03 19:15:16', NULL, TRUE, 'https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fwww.carefitness.com%2F1637-superlarge_default%2Fpresse-de-musculation-a-cuisses-45.jpg&f=1&nofb=1&ipt=2195a7020c4a429470a7e020c6d6a415d5ad97f2b8ef578ac1abd49f7796bbc6', 'L’appareil de musculation Press est conçu pour développer efficacement la force et la masse musculaire, tout en assurant un mouvement guidé et sécurisé. Idéal pour cibler des groupes musculaires spécifiques sans surcharge articulaire, il convient aussi bien aux débutants qu’aux sportifs expérimentés.  Selon le modèle (presse à jambes, chest press, shoulder press, etc.), il permet de travailler en isolation les muscles des jambes, pectoraux, épaules ou triceps.', NULL),
            (3, NULL, '019870f3-9205-7fe4-825c-ba83fae007d7', 'Home Gym,', '2025-08-03 19:21:07', NULL, TRUE, 'www.fitnessboutique.fr/cdn/shop/files/powphg1000x_principale_f.jpg?v=1734605450&width=1214', 'Le Home Gym est une station de musculation multifonctions conçue pour offrir un entraînement complet du corps, directement depuis chez vous. Compact, polyvalent et robuste, il regroupe plusieurs appareils en un seul pour travailler tous les groupes musculaires : bras, pectoraux, dos, jambes, abdominaux…  Parfait pour les utilisateurs de tous niveaux, il permet d’enchaîner les exercices sans changer de machine : poulies hautes et basses, développé assis (chest press), leg curl, butterfly, tirage horizontal, et plus encore.', NULL),
            (1, NULL, '019870e7-ec64-77fa-9909-6dc7379243de', 'Haltères', '2025-08-03 19:08:24', '2025-08-03 19:28:08', TRUE, 'https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fimages-eu.ssl-images-amazon.com%2Fimages%2FI%2F51MPR-165YL._AC_US500_QL65_.jpg&f=1&nofb=1&ipt=90eb650cc3f8a66bf375c3e82fade3818b4a74120b14a5fb41fecb6a0259a81f', 'Les haltères sont des équipements de musculation compacts et essentiels pour le renforcement musculaire à domicile ou en salle. Utilisables pour une large variété d''exercices (biceps, triceps, épaules, pectoraux, dos, jambes), ils permettent de travailler en charge libre, favorisant la coordination, l''équilibre et le gain de force.  Disponibles en versions fixes (poids défini) ou réglables (disques interchangeables ou mécanisme rotatif), ils s’adaptent à tous les niveaux : débutants comme confirmés', NULL),
            (4, NULL, '01987115-f9a2-794e-a1ad-6c9d87691603', 'Tapis de course', '2025-08-03 19:58:42', NULL, TRUE, 'https://contents.mediadecathlon.com/m18540130/k$76ae13ebcbd806ee306763d0a23bbea4/sq/m7000-tapis-de-course.jpg', 'Le tapis de course électrique est un équipement incontournable pour pratiquer la course à pied ou la marche rapide chez soi. Que vous soyez débutant ou sportif confirmé, il vous permet d’améliorer votre endurance, brûler des calories et maintenir votre forme tout au long de l’année, sans contraintes météo.', NULL)
        ");

        // Ajout des infos machines
        $this->addSql("INSERT INTO info_machine (id, machine_id, text, type) VALUES
            (1, 1, 'Polyvalents pour tout le corps', 'carac'),
            (2, 1, 'Peu encombrants', 'carac'),
            (3, 1, 'Adaptés au renforcement, à la tonification ou à la prise de masse', 'carac'),
            (4, 1, 'Excellents pour les circuits training ou les entraînements fonctionnels', 'carac'),
            (5, 1, 'Fonte brute, acier chromé, caoutchouc, néoprène ou vinyle selon l’usage et le confort', 'autre'),
            (6, 4, 'Mouvement guidé pour un entraînement sécurisé', 'sécurité'),
            (8, 2, 'Mouvement guidé pour un entraînement sécurisé', 'sécurité'),
            (9, 2, 'Ciblage précis des muscles', 'carac'),
            (10, 2, 'Réduction du risque de blessure', 'confort'),
            (11, 2, 'Idéal pour la progression en charge contrôlée', 'carac'),
            (12, 2, 'Confort d''utilisation grâce aux réglages ergonomiques', 'confort'),
            (13, 2, 'Structure en acier robuste', 'carac'),
            (14, 2, 'Siège réglable', 'carac'),
            (15, 2, 'Résistance par charge guidée ou poids libres', 'carac'),
            (16, 2, 'Poignées antidérapantes', 'carac'),
            (17, 4, 'Tout-en-un : travail complet du corps', 'autre'),
            (19, 4, 'Tout-en-un : travail complet du corps', 'autre'),
            (21, 3, 'Tout-en-un : travail complet du corps', 'autre'),
            (22, 3, 'Gain de place : idéal pour les petits espaces', 'autre'),
            (23, 1, 'Polyvalents pour tout le corps', 'carac'),
            (24, 1, 'Peu encombrants', 'carac'),
            (25, 1, 'Adaptés au renforcement, à la tonification ou à la prise de masse', 'carac'),
            (26, 1, 'Excellents pour les circuits training ou les entraînements fonctionnels', 'carac'),
            (27, 1, 'Fonte brute, acier chromé, caoutchouc, néoprène ou vinyle selon l’usage et le confort', 'autre'),
            (28, 4, 'Type d''utilisateur : débutant à avancé', 'usage'),
            (30, 4, 'Type d''utilisateur : débutant à avancé', 'usage'),
            (32, 4, 'Type d''utilisateur : débutant à avancé', 'usage'),
            (34, 4, 'Type d''utilisateur : débutant à avancé', 'usage'),
            (36, 4, 'Type d''utilisateur : débutant à avancé', 'usage'),
            (38, 4, ' débutant à avancé', 'usage'),
            (40, 4, 'Amorti : système d’absorption des chocs pour préserver les articulations', 'confort'),
            (41, 4, 'système d’absorption des chocs pour préserver les articulations', 'confort'),
            (42, 4, 'système d’absorption des chocs pour préserve', 'confort')
        ");

        // Ajout du post de test
        $this->addSql("INSERT INTO post (id, forum_id, titre, date_creation, vues, verrouille, epingle, utilisateur_id) VALUES
            (1, 2, 'efzfez', '2025-08-03 20:33:00', 0, FALSE, FALSE, 1)
        ");
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DELETE FROM forum WHERE id = 2');

        // Suppression des machines insérées
        $this->addSql('DELETE FROM machine WHERE id IN (1,2,3,4)');

        // Suppression des infos machines insérées
        $this->addSql('DELETE FROM info_machine WHERE id BETWEEN 1 AND 42');

        // Suppression du post de test
        $this->addSql('DELETE FROM post WHERE id = 1');
    }
}
